"""Training entrypoint for gene-to-isoform prediction with PCA + residual MLP."""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train residual MLP to map genes -> isoforms with PCA inputs.")
    parser.add_argument(
        "--gene-h5ad",
    ...
    parser.add_argument(
        "--save-dir",
        type=Path,
        default=Path("isoform_model_residual_pca"),
...
def main():
    ...
    if valid_corr.size == 0:
        ...
        corr_plot_path = args.save_dir / "isoform_correlation_boxplot_pca_residual.png"
    ...
    log_path = args.save_dir / "pred_vs_true_scatter_residual_pca_log.png"
    ...
    # Per-gene Spearman correlation of isoform ranks computed per observation
    if not args.skip_gene_rank:
        ...
        if valid_mean.any():
            ...
            mean_box_path = args.save_dir / "gene_rank_corr_mean_boxplot_residual_pca.png"
            plt.figure(figsize=(6, 4))
        ...
        if valid_median.any():
            ...
            median_box_path = args.save_dir / "gene_rank_corr_median_boxplot_residual_pca.png"
            plt.figure(figsize=(6, 4))
